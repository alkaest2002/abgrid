...
class ElectronApp {
    constructor() {
        ...
        this.webAppUrl = "https://abgrid-webapp.onrender.com";
    }
    ...
    setupIpcHandlers() {
        ...
        ipcMain.on("download-link", (event, downloadUrl) => {
            const win = BrowserWindow.fromWebContents(event.sender);
            win && win.webContents.downloadURL(downloadUrl);
        });

        // Add app info handler for the web app to identify it's running in Electron
