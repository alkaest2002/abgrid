...
import viewMultistepJson from "./views/view.multistep.json";
import viewMultistepReport from "./views/view.multistep.report";
...
export const initAlpine = () => {
  ...
  Alpine.data("viewMultistepJson", viewMultistepJson);
  Alpine.data("viewMultistepReport", viewMultistepReport);
  Alpine.start();
