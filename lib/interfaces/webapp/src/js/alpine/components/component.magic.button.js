...
export default (label, action) => ({
    ...
    init() {
        Alpine.effect(() => this.$store.app.appMagicButtonIsLocked = !this.$store.app.appIsOnline);
        Alpine.effect(() => this.$store.app.appMagicButtonIsLocked = !this.$store.api.apiServerIsReachable);
    },
