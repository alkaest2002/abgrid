export default (label, action) => ({
    ...
    magicButton: {
        ...
        [":class"]() {
            const isDisabled = this.$store.app.appMagicButtonIsLocked || this.$store.api.apiRequestIsPending
            ...
            return this.magicButtonMetaKeyIsPressed 
                ? `${isDisabledMeta} bg-purple-600/90 hover:bg-purple-700/90 focus:ring-purple-300/50 ${this.magicButtonClasses}`
                : `${isDisabled} bg-blue-600/90 hover:bg-blue-700/90 focus:ring-blue-300/50 ${this.magicButtonClasses}`
        },
