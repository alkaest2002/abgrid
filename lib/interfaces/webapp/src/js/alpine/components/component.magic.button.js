export default (label, action) => ({
    ...
    magicButtonClasses: "h-18 w-18 rounded-full text-sm font-medium text-white border-0 shadow-xl inline-flex justify-center items-center backdrop-blur-sm focus:ring-4 transform hover:scale-105 transition-all duration-300 ease-out",
