...
export default () => ({
    ...
    async queueMakeApiRequest() {
        ...
        if (statusCode == 200) {
            ...
            // Go to different pages on the base of the endopoint
            endpoint == "api/group" && this.navigationGoTo("dropzone.data");
            endpoint == "api/report" && this.navigationGoTo("notify.report");
            endpoint == "api/report/step_1" && this.navigationGoTo("multistep.sociogram");
            endpoint == "api/report/step_2" && this.navigationGoTo("multistep.json");
            endpoint == "api/report/step_3" && this.navigationGoTo("multistep.report");
