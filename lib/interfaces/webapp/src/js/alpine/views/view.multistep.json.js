...
export default () => ({
    ...
    init() {
        ...
        // Watch changes
        this.$watch("multistepJSONFileWasDownloaded", (newValue) => {
    ...
    multistepJSONFileWasDownloaded: false,
        ...
        return this.$store.app.appIsElectron
            ...
            ? {
                    async ["@click.prevent"]() {
                        ...
                        this.multistepJSONFileWasDownloaded = true;
                    }
                }
            // Web app
            : {
                    ["@click.prevent"]() {
                        ...
                        downloadLink(blob, filename)
                            ...
                            .finally(() => this.multistepJSONFileWasDownloaded = true);
                        this.multistepJSONSpinner = false;
                    }
                }
    },
