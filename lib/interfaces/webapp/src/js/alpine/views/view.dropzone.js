...
export default () => ({
    ...
    init() {
        ...
        this.$store.app.appMagicButtonIsLocked = !this.$store.data.dataYAML;

        // Watch for changes in store data Yaml
    ...
    dropzone: {
        ["@click"]() {
            ...
            // Do nothing if file is already loaded
            if (this.$store.data.dataFilename)
                return;
        ...
        ["@textarea:input"]({ detail }) {
            ...
            this.$store.data.dataJSON = !detail && {};
        }
    },
