export default () => ({
    ...
    serverIsAlive: true,
    serverIsAliveMessage: "alive_and_kicking",

    get serverStatusMessage() {
        return this.$store.api.apiServerIsReachable
            ? `<span>&#128994;</span> <span class='italic'>${this.$t('fastapi.alive_and_kicking')}</span>`
            : `<span>&#128308;</span> <span class='italic'>${this.$t('fastapi.down')}</span>`
    },
