export default () => ({
    ...
    async init() {
        ...
        // Preload routes
        window.Taxi.preload(`${this.$store.app.appLanguage}.generate.html`);
        window.Taxi.preload(`${this.$store.app.appLanguage}.dropzone.html`);
        window.Taxi.preload(`${this.$store.app.appLanguage}.notify.html`);
    },
