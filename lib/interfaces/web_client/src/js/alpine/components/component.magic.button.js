export default (label, action, customClasses = "bg-blue-700 border-blue-700") => ({
    ...
    magicButtonInitialClasses: "h-12 w-12 rounded-full text-sm font-medium text-white border shadow-sm inline-flex justify-center items-center",
    ...
    magicButton: {
        ...
        [":class"]() {
            ...
            return this.magicButtonMetaKeyIsPressed 
                ? `${isDisabled} bg-red-700 border-red-700 ${this.magicButtonInitialClasses}`
