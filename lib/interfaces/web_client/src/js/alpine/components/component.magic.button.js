export default (label, action) => ({
    ...
    magicButtonClasses: "h-15 w-15 rounded-full text-sm font-medium text-white border shadow-sm inline-flex justify-center items-center",
    ...
    magicButton: {
        ...
        [":class"]() {
            ...
            return this.magicButtonMetaKeyIsPressed 
                ? `bg-purple-700 border-purple-700 shadow-purple-900 cursor-pointer ${this.magicButtonClasses}`
        ...
        async ["@click"]({ metaKey }) {
            ...
            // Do nothing if magic button is locked
            if (this.$store.abgrid.magicButtonIsLocked)
                return
            // Lock magic button
