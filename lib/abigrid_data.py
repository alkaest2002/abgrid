        ...
        if project_data is not None:
            ...
            if group_data is not None:
                ...
                report_data = {
                    ...
                    "edges_a": ntw.edges_a,
                    "edges_b": ntw.edges_b,
                    "macro_stats_a": ntw.macro_stats_a,
                    "macro_stats_b": ntw.macro_stats_b,
                    "micro_stats_a": ntw.micro_stats_a.to_dict("index"),
                    "micro_stats_b": ntw.micro_stats_b.to_dict("index"),
                    "nodes_a_rankings": ntw.nodes_a_rankings,
